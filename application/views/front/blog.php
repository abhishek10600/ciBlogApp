...
<div class="container">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-8">
            <p class="bg-light pt-2 pb-2 pl-3"><a href="<?php echo base_url('Blog/category/'.$article['category']);?>"
                    class="text-muted text-uppercase"><?php echo $article['category_name'] ?></a></p>
            ...
            <a href="<?php echo base_url('blog/detail/'.$article['id']);?>">Read more</a>
