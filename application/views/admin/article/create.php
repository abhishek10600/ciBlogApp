                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    type="text" name="title" id="title" value="<?php echo set_value('title') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="image" id="image" class="<?php echo (!empty($imageError)) ? 'is-invalid' : ''; ?>">
                                <?php
